  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: t.bg }]}>
      ...
      <ScrollView contentContainerStyle={styles.scroll} keyboardShouldPersistTaps="handled">
        ...
        <Text style={[styles.label, { color: t.textSub, marginTop: 12 }]}>Estado</Text>
        <View style={styles.chipRow}>
          {ESTADOS.map(e => (
            <TouchableOpacity 
              ...
              style={[
                styles.chip, 
                { borderColor: t.cardBorder, backgroundColor: estado === e ? t.primary : t.bg3 }
              ]}
              onPress={() => setEstado(e)}
            >
        ...
        <View style={[styles.inputContainer, { backgroundColor: t.inputBg, borderColor: t.inputBorder }]}>
          <Ionicons name="people-outline" size={18} color={t.textMuted} style={styles.inputIcon} />
          <TextInput 
            style={[styles.input, { color: t.text }]} 
        ...
        <TextInput 
          style={[styles.textArea, { backgroundColor: t.inputBg, borderColor: t.inputBorder, color: t.text }]}
          placeholder="Antecedentes, medicamentos actuales..."
          placeholderTextColor={t.textMuted} 
          value={notas} 
...
const styles = StyleSheet.create({
  ...
  dropdownMenu: { borderWidth: 1, borderRadius: 10, marginBottom: 8, overflow: 'hidden' },
