      ...
      <ScrollView contentContainerStyle={styles.scroll}>
        ...
        <View style={[styles.section, { backgroundColor: t.card, borderColor: t.cardBorder }]}>
          <TouchableOpacity style={styles.settingRow}>
            ...
            <View style={styles.settingText}>
              <Text style={[styles.settingLabel, { color: t.text }]}>Centro de Ayuda</Text>
            </View>
            <Ionicons name="chevron-forward" size={16} color={t.textMuted} />
          </TouchableOpacity>
          ...
          <TouchableOpacity style={styles.settingRow}>
            ...
            <View style={styles.settingText}>
              <Text style={[styles.settingLabel, { color: t.text }]}>Contactar Soporte</Text>
            </View>
            <Ionicons name="chevron-forward" size={16} color={t.textMuted} />
          </TouchableOpacity>
          ...
          <TouchableOpacity style={styles.settingRow}>
            ...
            <View style={styles.settingText}>
              <Text style={[styles.settingLabel, { color: t.text }]}>Términos y Condiciones</Text>
            </View>
            <Ionicons name="chevron-forward" size={16} color={t.textMuted} />
          </TouchableOpacity>
        </View>
