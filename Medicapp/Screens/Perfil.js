    ...
    <SafeAreaView style={[styles.container, { backgroundColor: t.bg2 }]}>
      ...
      <ScrollView contentContainerStyle={styles.scroll}>
        <View style={styles.avatarSection}>
          ...
          <Text style={[styles.doctorName, { color: t.text }]}>Dr. Carlos Méndez</Text>
          <Text style={[styles.doctorRole, { color: t.textSub }]}>Médico General</Text>
        </View>

        <InfoSection title="Información Personal" icon="person-outline" iconColor="#2563EB" t={t}>
          <InfoRow label="Nombre Completo" value="Carlos Méndez Arriaga" t={t} />
          <InfoRow label="Email" value="carlos.mendez@clinica.com" t={t} />
          <InfoRow label="Teléfono" value="+34 612 345 678" t={t} last />
        </InfoSection>

        <InfoSection title="Información Profesional" icon="medical-outline" iconColor="#7C3AED" t={t}>
          <InfoRow label="Especialidad" value="Medicina General" t={t} />
          <InfoRow label="Colegio Médico" value="CM-28-45678" t={t} />
          <InfoRow label="Centro de Trabajo" value="Clínica San Rafael" t={t} last />
        </InfoSection>
